...
public class Solution {
    ...
    public static void sort(List<Stock> list) {
        list.sort(((Comparator<Stock>) (stock1, stock2) -> ((String) stock1.get("name")).compareTo((String) stock2.get("name")))
                .thenComparing(((Comparator<Stock>) (stock1, stock2) -> ((Date) stock2.get("date")).compareTo(((Date) stock1.get("date"))))
